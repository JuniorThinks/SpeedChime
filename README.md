<h1 align="center">Speed Chime</h1>

<p align="center">
  <i>Маленькая программа для <b>Forza Horizon</b>, которая издает звук (как в японских машинах), когда ты разгоняешься выше определенной скорости.</i>
</p>
